...
export function getForecastIcon(code, description, isDay){
  ...
  switch(code){
    case 0: //ClearSky
      if (isDay)
        return "../resources/icons/weather/0_sun.png"
      else
    ...
    case 2: //Scattered Clouds
      if (isDay)
        return "../resources/icons/weather/1_sunny.png"
      else
        return "../resources/icons/weather/whitePartlyMoon.png"
      break;
    case 3: //BrokenClouds
      return "../resources/icons/weather/2_cloudy-night.png"
      break;
    case 4: //ShowerRain
    case 5: //Rain
     return "../resources/icons/weather/4_sprinkle.png"
      break;
    case 6: //Thunderstorm
      if (wordStartsWith("T", description))
        return "../resources/icons/weather/6_storm.png"
      else
        return "../resources/icons/weather/5_raindrop.png"
      break;
    case 7: //Snow
      return "../resources/icons/weather/7_snowy.png"
      break;
    case 8: //Mist
      return "../resources/icons/weather/8_haze.png"
      break;
    default: //Other
      if (isDay)
        return "../resources/icons/weather/0_sun.png"
